...
Представь результат в виде структурированного текста, описывая каждый кластер отдельно. ИСпользуй структурированные методы вывода информации (списки, логически блоки, маркированные списки и прочее).
